...
/// This test is a demonstration of how to create arbitrary DOM structure,
/// read and write it using reactive JSON library.

/// This will be our dom (20 LoC)
...
struct Node
{
    ...
    Node& operator[] (size_t array_index);
    Node& operator() (const char* object_field_key);
...
/// This will be our DOM reader (16 LoC)
...
// This will be our DOM writer (16 LoC)
